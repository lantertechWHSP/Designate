...
const Preview:any = () : ReactNode => {
    ...
    return (
        <Box width="100%" left={0} right={0} bottom={0} position="fixed" zIndex="300" background="white" height="50px" lineHeight="50px" fontSize="16px" borderTop="1px solid" borderColor="charcoal">
            <Container>
